...
import 'package:mywhatsapp/widget/widget.dart';
...
class ChatDetailState extends State<ChatDetailScreen> {
  ...
  addMessage() {
    if (messageEditingController.text.isNotEmpty) {
      ...
      DatabaseMethods().addMessage(widget.model.chatRoomId, chatMessageMap);
  ...
  @override
  void initState() {
    DatabaseMethods().getChats(widget.model.chatRoomId).then((val) {
      setState(() {
        chats = val;
      });
    });
        ...
        title: Row(
          children: [
            CircleAvatar(
              ...
              backgroundImage: NetworkImage(widget.model.user.avatarUrl),
            ),
            Padding(
